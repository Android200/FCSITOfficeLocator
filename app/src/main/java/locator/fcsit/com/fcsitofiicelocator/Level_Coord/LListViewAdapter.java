...
public class LListViewAdapter extends BaseAdapter {
    // Declare Variables
    Context mContext;
    LayoutInflater inflater;
    private List<LPopulation> populationlist = null;
    private ArrayList<LPopulation> arraylist;

    public LListViewAdapter(Context context,
                            List<LPopulation> populationlist) {
        mContext = context;
        this.populationlist = populationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<LPopulation>();
    ...
    @Override
    public LPopulation getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.llistview_item, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, LSingleItemView.class);
