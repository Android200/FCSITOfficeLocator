...
public class DListViewAdapter extends BaseAdapter {
    ...
    private List<DPopulation> populationlist = null;
    private ArrayList<DPopulation> arraylist;

    public DListViewAdapter(Context context,
                            List<DPopulation> populationlist) {
        mContext = context;
        this.populationlist = populationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<DPopulation>();
    ...
    @Override
    public DPopulation getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.dlistview_item, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, DSingleItemView.class);
