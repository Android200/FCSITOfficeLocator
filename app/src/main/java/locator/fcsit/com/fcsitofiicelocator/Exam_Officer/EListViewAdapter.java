...
public class EListViewAdapter extends BaseAdapter {
    ...
    private List<EPopulation> populationlist = null;
    private ArrayList<EPopulation> arraylist;

    public EListViewAdapter(Context context,
                            List<EPopulation> populationlist) {
        mContext = context;
        this.populationlist = populationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<EPopulation>();
    ...
    @Override
    public EPopulation getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.elistview_item, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, ESingleItemView.class);
