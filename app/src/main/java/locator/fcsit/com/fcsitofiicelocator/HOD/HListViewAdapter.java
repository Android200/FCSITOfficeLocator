...
public class HListViewAdapter extends BaseAdapter {
    ...
    private List<HPopulation> populationlist = null;
    private ArrayList<HPopulation> arraylist;

    public HListViewAdapter(Context context,
                            List<HPopulation> populationlist) {
        mContext = context;
        this.populationlist = populationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<HPopulation>();
    ...
    @Override
    public HPopulation getItem(int position) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.hlistview_item, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, HSingleItemView.class);
